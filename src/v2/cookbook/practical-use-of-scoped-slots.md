...
Debajo hay un ejemplo de cómo se puede lograr esto. Analizaremos el código pieza por pieza y veremos, en la siguiente sección, qué es lo que realmente está sucediendo.
...
Hasta ahora todo bien. Podríamos continuar añandiendo objetos al mapa (Marcadores, Líneas Polígonales, etc.) y usarla como si fuera un componente ordinario.
...
Nuestro _script tag_ se verá de la siguiente forma:
